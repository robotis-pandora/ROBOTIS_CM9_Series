...
public class Target {
  ...
  public Target(String name, File folder) {
   ...
   //[ROBOTIS[[DEBUG]
   // JOptionPane.showMessageDialog(null, boardsFile.getAbsolutePath());
    try {
  ...
  public Map<String, Map<String, String>> getBoards() {
	///System.out.println("[Target]getBoards() boards="+boards.values());
    return boards;
  }
  public Map<String, Map<String, String>> getProgrammers() {
	  ///System.out.println("[Target]getProgrammers() getProgrammers="+programmers.values());
    return programmers;
  }
}