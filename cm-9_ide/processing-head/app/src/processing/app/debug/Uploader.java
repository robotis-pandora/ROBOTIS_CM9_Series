...
public abstract class Uploader implements MessageConsumer  {
  ...
  protected void flushSerialBuffer() throws RunnerException, SerialException {
    ...
    try {
      ...
      //System.out.println("[Uploader]uploadUsingPreferences() Port list : "+Serial.list());
      byte[] readBuffer;
    ...
    throws RunnerException
  {
    ...
    try {
      ...
      System.out.println("executeUploadCommand() start upload commandArray =");
      for(String tmp : commandArray){
    	  System.out.print(tmp); System.out.print("   ");
    	  System.out.println();
